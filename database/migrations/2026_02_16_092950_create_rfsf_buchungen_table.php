...
return new class extends Migration {
    ...
    {
        Schema::create('rfsf_buchungen', function (Blueprint $table) {
            $table->id();
            $table->text('notiz')->nullable();
            $table->string("email");
            $table->unsignedInteger("mitgliedsnummer")->nullable();
            // aktuell kursnummer von Hand von bigint auf varchar ändern!
            // $table->foreignId("kursnummer")->constrained("rfsf_kurse", "nummer")->onDelete("cascade");
            $table->string("kursnummer")->constrained("rfsf_kurse", "nummer")->onDelete("cascade");
    ...
    {
        Schema::dropIfExists('rfsf_buchungen');
    }
};
